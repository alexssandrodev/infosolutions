...
import { IconCpu, IconDeviceMobile, IconHome, IconMenu, IconTools, IconX } from '@tabler/icons-react';
        ...
        <header className="header__container">
            <div className="box_header">
                <div className="box_logo">
                    <div className="logo">
                        <Image className='alex-logo' src='/infosolutions-logo.png' width={300} height={52} alt='Logotipo Alex 1' />
                    </div>
